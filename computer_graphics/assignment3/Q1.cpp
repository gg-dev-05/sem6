...
/**
 * @brief drawing lines using bresenham line drawing algorithm
 *
 * @return std::vector<std::pair<int, int>> vector containing all points in order
 */
std::vector<std::pair<int, int>> drawWithBresenham() {
    std::vector<std::pair<int, int>> bresenham_points;
    ...
    // bresenham algorithm for slope b/w 0 & 1
...
void draw() {
    auto bresenham_points = drawWithBresenham();
...
int main(int argc, char *argv[]) {
    ...
    glutCreateWindow("Assignment 3 : (Bresenham Line Drawing Algorithm)");
