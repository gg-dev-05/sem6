...
void draw() {
    ...
    glBegin(GL_QUADS);
    glVertex3f(-4.0, -1.6, 2.0);
    glVertex3f(10, -1.6, 2.0);
    glVertex3f(10, -1.6, -2.0);
    glVertex3f(-4.0, -1.6, -2.0);
    ...
    glBegin(GL_QUADS);
    glVertex3f(-3.5, -1.6, 1.0);
    glVertex3f(-2.0, -1.6, 1.0);
    glVertex3f(-2.0, -0.1, 1.0);
    glVertex3f(-3.5, -0.1, 1.0);

    // left wall window
    glColor3f(0.4, 0.1, 0.0);
    glBegin(GL_QUADS);
    glVertex3f(-3.0, -1.0, 1.0001);
    glVertex3f(-2.5, -1.0, 1.0001);
    glVertex3f(-2.5, -0.5, 1.0001);
    glVertex3f(-3.0, -0.5, 1.0001);
    ...
    glColor3f(0.4, 0.1, 0.0);
    glBegin(GL_QUADS);
    glVertex3f(-1.999, -1.5, -0.5);
    glVertex3f(-1.999, -0.3, -0.5);
    glVertex3f(-1.999, -0.3, 0.0);
    glVertex3f(-1.999, -1.5, 0.0);

    // window for front
    glColor3f(0.4, 0.1, 0.0);
    glBegin(GL_QUADS);
    glVertex3f(-1.999, -1.0, 0.3);
    glVertex3f(-1.999, -0.5, 0.3);
    glVertex3f(-1.999, -0.5, 0.7);
    glVertex3f(-1.999, -1.0, 0.7);
    ...
    glVertex3f(-3.5, -0.1, 1.1);
    glVertex3f(-2.0, -0.1, 1.1);
    glVertex3f(-2.75, 0.9, 0.0);
    glVertex3f(-2.75, 0.9, 0.0);
